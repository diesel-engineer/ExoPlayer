...
public final class TrackSelectionDialogBuilder {
  ...
  private Dialog buildForPlatform() {
    ...
    View dialogView = dialogInflater.inflate(R.layout.exo_mini_track_selection_dialog, /* root= */ null);
  ...
  private Dialog buildForAndroidX() {
    try {
      ...
      View dialogView =
          dialogInflater.inflate(R.layout.exo_mini_track_selection_dialog, /* root= */ null);
      Dialog.OnClickListener okClickListener = setUpDialogView(dialogView);
